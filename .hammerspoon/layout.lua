...
layoutLab = function()
  ...
  local right = {
      {'Notion', nil, LAB_RIGHT_MONITOR, u(0, 0.3, 1, 0.7), nil, nil, visible=true},
      {'邮件', nil, LAB_RIGHT_MONITOR, u(0, 0, 1, 0.5), nil, nil, visible=true},
      {'日历', nil, LAB_RIGHT_MONITOR, u(0, 0.4, 1, 0.5), nil, nil, visible=true},
    }

  local left = {
    {'Code', nil, LAB_LEFT_MONITOR, u(0, 0, 1, 1), nil, nil, visible=true},
    {'iTerm2', nil, LAB_LEFT_MONITOR, u(0, 0, 1, 1), nil, nil, visible=true},
    {'Microsoft Edge', nil, LAB_LEFT_MONITOR, u(0, 0, 1, 1), nil, nil, visible=true},
  }
